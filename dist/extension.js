				...
				t && "/sample-folder/large.ts" === t.fileName
					? e.set(t.uri, [
							...
							},
							{
								code: "",
								message:
									"function does not follow naming conventions",
								range: new s.Range(
									new s.Position(7, 10),
									new s.Position(7, 23)
								),
			...
			e.activate = function (t) {
				if ("object" == typeof navigator) {
					(function (t) {
						...
						(function (t) {
							const e =
								s.languages.createDiagnosticCollection("test");
								...
								open(t) {
									if (this.flags.indexOf("watch") > -1) {
										let t =
											...
											"/customBuildFile";
										(this.fileWatcher =
											s.workspace.createFileSystemWatcher(
												t
											)),
		...
		function (t, e, r) {
			...
			class l {
				constructor() {
					(this.root = new o(n.Uri.parse("memfs:/"), "")),
						...
						(this.disposable = n.Disposable.from(
							n.workspace.registerFileSystemProvider(
								l.scheme,
								this,
								{ isCaseSensitive: !0 }
							),
							n.workspace.registerFileSearchProvider(
								l.scheme,
								this
							),
							n.workspace.registerTextSearchProvider(
								l.scheme,
								this
							)
						));
				...
				seed() {
					this.createDirectory(n.Uri.parse("memfs:/sample-folder/")),
						...
						this.createDirectory(
							n.Uri.parse("memfs:/sample-folder/folder/")
						),
						this.createDirectory(
							n.Uri.parse("memfs:/sample-folder/workspaces/")
						),
						this.createDirectory(
							n.Uri.parse("memfs:/sample-folder/large/")
						),
						this.createDirectory(
							n.Uri.parse("memfs:/sample-folder/xyz/")
						),
						this.createDirectory(
							n.Uri.parse("memfs:/sample-folder/xyz/abc")
						),
						this.createDirectory(
							n.Uri.parse("memfs:/sample-folder/xyz/def")
						),
						this.writeFile(
							n.Uri.parse(
								"memfs:/sample-folder/folder/empty.txt"
							),
							new Uint8Array(0),
							{ create: !0, overwrite: !0 }
						),
						this.writeFile(
							n.Uri.parse(
								"memfs:/sample-folder/folder/empty.foo"
							),
							new Uint8Array(0),
							{ create: !0, overwrite: !0 }
						),
						...
						this.writeFile(
							n.Uri.parse(
								"memfs:/sample-folder/workspaces/mem.code-workspace"
							),
							a.encode(
								JSON.stringify(
									{
						...
						this.writeFile(
							n.Uri.parse(
								"memfs:/sample-folder/encodings/windows1251.txt"
							),
							s.windows1251File,
							{ create: !0, overwrite: !0 }
						),
						this.writeFile(
							n.Uri.parse(
								"memfs:/sample-folder/encodings/gbk.txt"
							),
							s.gbkFile,
							{ create: !0, overwrite: !0 }
						);
				...
				_rtrim(t, e) {
					...
					for (
						;
						(i = t.lastIndexOf(e, s - 1)), -1 !== i && i + r === s;
				...
				_findFiles(t) {
					const e = this._getFiles(),
						r = [],
						n = t
							? new RegExp(this._convertSimple2RegExpPattern(t))
							: null;
				...
				provideTextSearchResults(t, e, r, s) {
					...
					if (i)
						for (const e of i) {
							const s = this._textDecoder
								.decode(this.readFile(e))
								.split("\n");
